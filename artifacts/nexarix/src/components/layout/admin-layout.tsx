...
import { LogOut, Menu, LayoutDashboard, Users, CheckSquare, Wallet, Settings, ChevronRight, Shield, ShoppingBag, GraduationCap, LayoutGrid, Bell } from "lucide-react";
...
const NAV = [
  ...
  { name: "Notifications",   href: "/admin/notifications",    icon: Bell,            accent: "from-blue-400 to-sky-500",       dot: "bg-sky-400"     },
