...
import { LogOut, Menu, User, LayoutDashboard, CheckSquare, Wallet, Users, MessageCircle, Phone, Settings } from "lucide-react";
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const NavContent = () => (
    <div className="flex h-full flex-col gap-4">
      <div className="flex h-14 items-center px-4 font-bold text-xl text-primary">NEXARIX</div>
    ...
    <div className="flex min-h-screen w-full bg-muted/40">
      ...
      <div className="flex flex-col flex-1">
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-background px-4 md:px-6 md:h-[60px]">
          ...
          <div className="w-full flex-1 font-semibold md:hidden">NEXARIX</div>
