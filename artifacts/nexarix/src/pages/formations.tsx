      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="relative z-10 p-5 flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-[10px] font-bold uppercase tracking-widest mb-0.5">Nexarix</p>
              <h1 className="font-black text-xl leading-tight">Formations</h1>
              <p className="text-orange-100 text-xs font-medium mt-0.5">Apprenez · Progressez · Gagnez</p>
            </div>
