      ...
      <div className="space-y-5">
        ...
        <motion.div custom={1} variants={card} initial="hidden" animate="visible">
          <a
            ...
            data-testid="button-contact-whatsapp-support"
            className="block bg-white rounded-3xl border border-gray-100 shadow-sm p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <h2 className="font-black text-lg text-gray-900 leading-tight">Support WhatsApp</h2>
                <p className="text-green-600 font-semibold text-sm mt-0.5">Réponse rapide garantie</p>
              </div>
              <div className="h-9 w-9 rounded-xl bg-gray-100 flex items-center justify-center shrink-0">
                <ExternalLink className="h-4 w-4 text-gray-500" />
              </div>
            ...
            <p className="text-gray-500 text-xs mt-3 pl-[4.5rem]">
              Contactez notre support directement via WhatsApp pour une assistance prioritaire.
            </p>
          </a>
        </motion.div>
        ...
        <motion.div custom={3} variants={card} initial="hidden" animate="visible">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            data-testid="button-contact-whatsapp-community"
            className="block bg-white rounded-3xl border border-gray-100 shadow-sm p-5 hover:shadow-lg hover:-translate-y-0.5 transition-all"
          >
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-teal-500 to-green-600 flex items-center justify-center shrink-0 shadow-lg shadow-teal-200">
                <SiWhatsapp className="h-7 w-7 text-white" />
              </div>
              <div className="flex-1">
                ...
                <p className="text-teal-600 font-semibold text-sm mt-0.5">Actualités & mises à jour</p>
              </div>
              <div className="h-9 w-9 rounded-xl bg-gray-100 flex items-center justify-center shrink-0">
                <ExternalLink className="h-4 w-4 text-gray-500" />
              </div>
